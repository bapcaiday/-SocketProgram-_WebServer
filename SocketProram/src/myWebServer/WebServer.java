...
public class WebServer implements Runnable
{
     ...
     public void run() {
        ...
        try {
            while (true) {
                ...
                if (clientRequest != null && clientRequest.indexOf(' ') != -1) {
    ...
    private int recv(BufferedReader in) throws IOException {
    ...
    private void fileUnauthorized(PrintWriter out,String fileRequested) throws IOException{
        ...
        out.write("Content-type: " + content + "\r\n");
        out.write("\r\n"); // blank line between headers and content
        out.write("<html><head><title>401 Unauthorized</title></head>" +
                "<body><p>This is a private area.</p></body></html>");
        out.flush();
